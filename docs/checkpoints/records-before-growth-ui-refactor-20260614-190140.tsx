...
const journalEntryIcon = require("../assets/icons/icon_leaf_transparent_alpha.png");
...
function BadgeTile({
  ...
  return (
    <Pressable accessibilityRole="button" onPress={onPress} style={({ pressed }) => pressed && styles.badgeTilePressed}>
      {content}
    </Pressable>
  );
}
...
function JournalEntryCard({ reviewCount }: { reviewCount: number }) {
  return (
    <Pressable
      accessibilityRole="button"
      style={({ pressed }) => [styles.journalEntryCard, pressed && styles.journalEntryPressed]}
    ...
    >
      ...
      <View style={styles.journalEntryCopy}>
        <Text style={styles.journalEntryTitle}>复盘日记本</Text>
        <Text style={styles.journalEntryBody}>
          {reviewCount > 0
...
const styles = StyleSheet.create({
  ...
  journalEntryCard: {
    ...
    borderRadius: 24,
    borderWidth: 1,
    borderColor: "rgba(230,213,184,0.25)",
